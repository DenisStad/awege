...
//        [renderEncoder popDebugGroup];
      ...
      UserInterface::SharedUserInterface().draw();
...
- (void)_reshape
{
  ...
  newSize.height = self.view.bounds.size.height;
  Window::SharedWindow().updateScaleFactor(2);
  Window::SharedWindow().updateSize(newSize);
}
